...
- (next) Coordination items: activation blocks for fix_sort_bet_matches + canonical_subasset_compact; operator decisions on APIv1 sql endpoint; user-environment validation (regtest, mainnet snapshot, hash compare).

...
| 6 | State integrity per table | PARTIAL | Hit `transactions_status` orphans on reorg, `0004` LEFT JOIN, `assets_info` latest-issuance drift (mig 0014). **TODO:** remaining per-table inventory. |

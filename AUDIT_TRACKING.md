...
- (next) Optional: subasset canonicalization scan via Python (decrypt + decode 4065 messages) to inform canonical_subasset_compact activation block. Otherwise: branch is functionally complete pending team coordination on activation blocks + operator decisions.
